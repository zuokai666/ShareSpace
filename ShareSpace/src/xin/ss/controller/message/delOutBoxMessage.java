 ...
 * 删除发件箱数据
 */
@WebServlet("/Message/delOutBoxMessage")
public class delOutBoxMessage extends HttpServlet {

	private static final long serialVersionUID = -806730078952110568L;
